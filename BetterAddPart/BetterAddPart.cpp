// BetterAddPart.cpp : Defines the exported functions for the DLL application.
//
...
class BetterAddPart : public HookMod {
public:
    std::wstring GetName() const override {
        return L"Litestone BetterAddPart Hookmod";
    }
